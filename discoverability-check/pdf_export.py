...
def generate_report_pdf(report: dict, image_bytes: bytes | None = None) -> bytes:
    ...
    doc = SimpleDocTemplate(
        ...
        title=f"Discoverability Report — {report.get('artist_name', 'Artist')}",
    )
    ...
    header_left = [
        ...
        Spacer(1, 2),
        Paragraph("Discoverability Report", h_sub),
    ...
    story.append(Paragraph(
        "Generated by Discoverability Check — built for the Musixmatch Musicathon 2026",
        footer_style,
    ))
